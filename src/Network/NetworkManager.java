...
public class NetworkManager {
      public class Request {
            ...
            public Request(String requestString) {
                ...
                while (matcher.find()) {
                    ...
                    requestString = requestString.substring(0, matcher.start()) + subrequest.getResult() + requestString.substring(matcher.end());
            ...
            public boolean hasResult() { return received; }
      ...
      public IP leaseIP(NetworkDevice device) throws NetworkException {
          MAIN:
            for (int i = poolStart.getAddressRaw(); i <= poolEnd.getAddressRaw(); i++) {
                for (IP lease : leases.keySet()) {
